...
impl SemanticAnalyzer {
 ...
 fn expr(&self,x:&Expr,e:&mut Vec<SemanticError>)->Result<VelaRiType,()>{match x{
  Expr::Literal(v,_)=>Ok(match v{Value::Number(_)=>VelaRiType::Number,Value::Boolean(_)=>VelaRiType::Boolean,Value::String(_)=>VelaRiType::String,Value::Null=>VelaRiType::Null,Value::Array(_)|Value::Map(_)=>VelaRiType::Unknown}),
